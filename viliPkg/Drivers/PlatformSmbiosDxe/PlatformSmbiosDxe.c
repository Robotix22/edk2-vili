...
CHAR8 mBiosVersion[128] = "edk2-vili";
...
CHAR8 *mProcessorInfoType4Strings[] = {
    "BGA-1156", "Qualcomm", "Qualcomm Snapdragon 888", NULL};
...
CHAR8 *mOemStringsType11Strings[] = {
    "https://github.com/Robotix22/edk2-vili", NULL};
    ...
    IN EFI_HANDLE ImageHandle, IN EFI_SYSTEM_TABLE *SystemTable)
{
  ...
  AsciiSPrint(
      mBiosVersion, sizeof(mBiosVersion), "edk2-vili %s",
