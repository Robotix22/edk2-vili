...
mkbootimg --kernel uefi_image --ramdisk ramdisk --kernel_offset 0x00000000 --ramdisk_offset 0x00000000 --tags_offset 0x00000000 --os_version 12.0.0 --os_patch_level "$(date '+%Y-%m')" --header_version 1 -o boot-vili.img
